jQuery(document).ready(function($) {
    ...
    $('body').on('click', '.tc-text-group .tc-group-controls .tc-icon-edit', function() {
        ...
        $(".tc-sidebar .md-text").find(".dataContent").addClass("activeContent");
        $(".tc-sidebar .md-text").find(".expandCollapse").addClass("active");
        $(this).off("click");
    });
