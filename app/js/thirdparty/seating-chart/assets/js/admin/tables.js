jQuery(document).ready(function($) {
    ...
    $('body').on('click', '#tc-table #tc_add_table_button', function() {
    ...
    $('body').on('click', '.tc-table-wrap .tc-group-controls .tc-icon-edit', function() {
        ...
        $(".tc-sidebar .md-chairs").find(".dataContent").addClass("activeContent");
        $(".tc-sidebar .md-chairs").find(".expandCollapse").addClass("active");
        $(this).off("click");
        $(this).attr("disabled", true);
    });
    ...
    $('body').on('click', '.tc-table-group .tc-group-controls .tc-icon-assign', function(e) {
        if (!toggleValue) {
            $(this).parent().parent('.tc-table-group').find('.ui-selectable').selectable({
                filter: '.tc_seat_unit',
                cancel: '.tc_seat_reserved',
                disabled: false
            });
            $(this).parent().parent('.tc-table-group').find(".tc-table-chair").addClass('tc_set_seat');
            $(".tc-sidebar").find(".dataContent").removeClass("activeContent");
            $(".tc-sidebar").find(".expandCollapse").removeClass("active");
            ...
            $(this).parent().parent('.tc-table-group').find(".tc-table-chair").removeClass('tc_set_seat');
            toggleValue = false;
        }
        e.preventDefault();
        $(this).off("click");
    ...
    window.tc_table = {
        ...
        create_square_table: function(edit) {
            ...
            var style_sizes = 'style="width: ' + ((table_width) + 74) + 'px; height: ' + ((table_height) + 50) + 'px;"';
            ...
            var group_style = 'width: ' + ((table_width) + 74) + 'px; height: ' + ((table_height) + 130) + 'px;';
            ...
            table_html += '<div class="tc-group-controls"><span class="tc-icon-edit"></span><span class="tc-icon-trash"></span><span class="tc-icon-assign"></span></div></div>';
            table_html += '</div>';
            table_html += '</div>';
        ...
        create_rounded_table: function(edit) {
            ...
            var grid_size = 5;
            var titleText = $('#tc-table .tc_table_title').val();
            var table_html = '';
            ...
            var style_sizes = 'style="width: ' + ((radius * 2) + 74) + 'px; height: ' + ((radius * 2) + 130) + 'px;"';

            var group_style = 'width: ' + ((radius * 2) + 74) + 'px; height: ' + ((radius * 2) + 130) + 'px;';
            var rotation_style = '-moz-transform:rotate(' + rotation + 'deg);-webkit-transform:rotate(' + rotation + 'deg);-o-transform:rotate(' + rotation + 'deg);-ms-transform:rotate(' + rotation + 'deg);';
        ...
        create_rounded_mixed_table: function(edit, value) {
            var rotation = 0;
            var empty_class = 'tc-empty-header';
            ...
            var title = value;
            var table_html = '';
            var numNodes = $('#tc_table_add_mixed').val();
            var radius = (numNodes * 24) / 5;
            if (radius < 40) {
                radius = 40;
            }
            ...
            if (edit == true) {
                ...
                var plusValue = radius;
                tc_controls.align_center($(new_element), value - 1, -150, plusValue);
            }
        ...
        table_rounded_chair_table: function(edit, value, leftValue, topValue, plusValue) {
            var rotation = 0;
            var empty_class = 'tc-empty-header';
            ...
            if (edit == true) {
                ...
                tc_controls.align_center($(new_element), leftValue - 1, topValue, plusValue);
            }
